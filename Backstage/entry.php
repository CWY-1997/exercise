...
<div class="box">
    ...
    <div class="main">
    	...
    	<div class="t">
        	<label class="la">当前位置:首页>发布新闻</label>
				<div class="pp">
		            <div id="cke">
					    <form action="entry_do.php" name="myForm" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
							<span style="font-size: 14px;"><b>新闻标题：</b></span> <input type="text"  placeholder="输入新闻标题" name="Title" id="title" class="in"/>
