        ...
        <div class="cd-hero">
                        ...
                        <div class="collapse navbar-toggleable-md text-xs-center text-uppercase tm-navbar" id="tmNavbar">
                            <ul class="nav navbar-nav">
                                <li class="nav-item active selected">
                                    <a class="nav-link" href="#0" data-no="1">团队比赛 <span class="sr-only">(current)</span></a>
                                </li>                                
                            </ul>
                        </div>                        
                    </div>
                            ...
                            <div class="tm-img-gallery-container">
                                ...
                                <!-- Gallery One pop up connected with JS code below -->
                                 	<?php
	                                	...
	                                	$db=new DBManager();
                                        $sql_data = "SELECT type_id,photo_title,photo_path FROM type_c WHERE type_id REGEXP '1' ORDER BY photo_id DESC";
                                        $res_contest = $db->getResult($sql_data);
                                        while($row = mysqli_fetch_array($res_contest)){
                                        	$filePath = "img1/".$row['photo_path'];	//拼接图片路径	数据库只存文件名
            ...
            <footer class="tm-footer">
                <div class="tm-social-icons-container text-xs-center">
                    ...
                    <a href="#" class="tm-social-link"><span style="color:#77C5E3;font-weight:bold">比赛</span><i class="fa fa-behance"></i></a>
                    ...
                    <a href="#" class="tm-social-link"><span style="color:#77C5E3;font-weight:bold">工作</span><i class="fa fa-linkedin"></i></a>
              </div>
