                        ...
                        <div class="collapse navbar-toggleable-md text-xs-center text-uppercase tm-navbar" id="tmNavbar">
                            <ul class="nav navbar-nav">
                                <li class="nav-item active selected">
                                    <a class="nav-link" href="#0" data-no="1">工作时刻 <span class="sr-only">(current)</span></a>
                                </li>                                
                            </ul>
                        </div>                        
                    </div>
                            ...
                            <div class="tm-img-gallery-container">
                                ...
                                <!-- Gallery One pop up connected with JS code below -->
                                	<?php
	                                	...
	                                	$db=new DBManager();
                                        $sql_data = "SELECT type_id,photo_title,photo_path FROM type_c WHERE type_id REGEXP '3' ORDER BY photo_id DESC";
                                        $res_contest = $db->getResult($sql_data);
                                        while($row = mysqli_fetch_array($res_contest)){
                                        	$filePath = "img3/".$row['photo_path'];	//拼接图片路径	数据库只存文件名
